...
Document.prototype = Object.create(Node.prototype, {
  ...
  domain: {
    get: function () {
      if (this._address) {
        if (this._address !== 'about:blank') {
          return this._address.split(/[:\/]+/g)[1];
        }
        return this._address;
      }
      return null;
  ...
  cookie: {
    get: function () {
      var this_ = this;
      return Object.keys(this._cookie).map(function (k) { return k + '=' + this_._cookie[k]; }).join('; ');
    },
    set: function (v) {
      var kvp = v.split('=');
      this._cookie[kvp[0]] = kvp[1];
    }
  },
